...
<div class="content">
    ...
    <tr>
      ...
      <th class="table_th p-5">About Teacher</th>
      <th class="table_th p-5">Image</th>
...
?>
    ...
    <tr>
      ...
      <td class="table_td p-5"> <img class="w-50 h-25" src="<?php  echo"{$info['image']}"   ?>" > </td>
    ...
    <td class="table_td p-5 ">
        ...
        <a class='btn btn-success' href='admin_update_teacher.php?teacher_id={$info['id']}'>Update</a>";
        ?>
    </td>
    </tr>
